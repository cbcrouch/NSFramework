...
#ifdef DEBUG
    [NGLUtils checkShader:hVertexShader ofType:kVertexShader againstStatus:kCompileStatus];
    CHECK_GL_ERROR();
#endif
...
#ifdef DEBUG
    [NGLUtils checkShader:hFragShader ofType:kFragmentShader againstStatus:kCompileStatus];
    CHECK_GL_ERROR();
#endif
...
#ifdef DEBUG
    [NGLUtils checkShader:hProgram ofType:kProgram againstStatus:kLinkStatus];
...
+ (GLuint) createProgram:(NSString *)programName {
    ...
    GLuint hVertexShader = 0;
    GLuint hFragShader = 0;
    NSString* vertexSource = [NGLUtils loadShaderSourceWithName:programName ofType:kVertexShader];
    NSString* fragmentSource = [NGLUtils loadShaderSourceWithName:programName ofType:kFragmentShader];
    const GLchar *vs_source = [vertexSource cStringUsingEncoding:NSASCIIStringEncoding];
    const GLchar *fs_source = [fragmentSource cStringUsingEncoding:NSASCIIStringEncoding];
